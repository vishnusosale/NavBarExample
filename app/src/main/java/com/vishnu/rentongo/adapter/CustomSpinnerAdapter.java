...
/**
 * Created by Vishnu on 01-Mar-15.
 */
public class CustomSpinnerAdapter extends ArrayAdapter<String> {
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent) {
        ...
        View row = inflater.inflate(R.layout.temps_spinner_row, parent, false);
        TextView label = (TextView) row.findViewById(R.id.temps_spinner_text);
