...
public class AdventureGearFragment extends Fragment {

    private CardGridArrayAdapter mCardArrayAdapter;
	public AdventureGearFragment(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] subCategories = {
                "Bags and Packs","Camping Tents", "Devices and Gadgets", "Rain Ponchos", "Sleeping Bags and Mats"
        };
