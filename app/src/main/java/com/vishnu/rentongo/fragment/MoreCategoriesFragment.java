...
public class MoreCategoriesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] subCategories = {
                "Computers","Costume, Dresses and Accessories", "Vehicles", "Camera", "Office Furniture", "Musical Instruments",
                "Tools and Equipment", "Event and Wedding Supplies", "Medical Supplies", "Audio Visual Equipments"
        };
